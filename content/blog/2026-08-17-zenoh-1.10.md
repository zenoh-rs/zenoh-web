...
* The accept-replies API was stabilized — [#648](https://github.com/eclipse-zenoh/zenoh-kotlin/pull/648) by @milyin

* The build now uses the [Gradle wrapper](https://docs.gradle.org/current/userguide/gradle_wrapper.html) — [#467](https://github.com/eclipse-zenoh/zenoh-java/pull/467) by @milyin
