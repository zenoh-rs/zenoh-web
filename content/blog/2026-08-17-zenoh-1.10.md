...
<!-- TODO: one sentence on the codename's origin and what it symbolizes for this release. -->
...
Zenoh 1.10.x **CODENAME** is a release about the parts of the system you normally do not see. Nothing here changes how you write a publisher or a subscriber, but the bytes now leave the kernel faster on Linux, the JVM bindings stop paying a JNI tax on every field, and when something is slower than you expect, the message itself can tell you which hop cost you the time.
